...
exports.validateCnpj = exports.CNPJ_MASK = undefined;
...
var CnpjMask = function (_BaseMask) {
    ...
    function CnpjMask() {
      ...
      return _possibleConstructorReturn(this, (CnpjMask.__proto__ || Object.getPrototypeOf(CnpjMask)).apply(this, arguments));
    }
    ...
    }], [{ key: 'getType', value: function getType() {return 'cnpj';} }]);
    return CnpjMask;
  }(_base2.default);
